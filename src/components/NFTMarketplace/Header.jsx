    ...
    return (
        <header className="style-12">
            <div className="container">
                <div className="info">
                    <h2> Discover </h2>
                    <h2 className="line-title"><span className="line-text">  & Get Super </span> <small> The Worlds Largest Digital Marketplace <br/> For Crypto Collectibles And
                        Non-Fungible <br/> Tokens for worldwide. </small></h2>
