...
const Content = ({style, rtl}) => {
    return (
        <>
            <h4 className="fw-bold color-000 lh-4 mb-30">{rtl ? 'بمناسبة العرض الأول في المملكة المتحدة للفنان هنري باراندي ، المطور' : 'To mark the first UK show of artist Henri Barande, developer'}
                <a href="#"
                   className={`color-blue${style}`}>{rtl ? 'موسي' : 'Moussa'}</a> {rtl ? 'واستوديو Schultzschultz الألماني قاما بإنشاء The Lodge Wooden في مدينة برلين' : 'and German studio Schultzschultz  have created The Lodge Wooden at Berlin City'}
            </h4>
            ...
            <div className="twitter-info mt-60">
                <div className="twitter-card">
                    ...
                    <div className="twitter-info mt-40">
                        <h5>
                            “{rtl ? 'فريق في' : 'The team at'} <a href="#"
                ...
                <div className="text color-666 mt-30">
                    {rtl ? 'هذا على الفور جلب إلى الأذهان واحد من' : 'That immediately brought to mind one of'} <a href="#"
                                                                                                                   className={`text-decoration-underline color-blue${style}`}>{rtl ? 'اعز' : 'my fondest'}</a> {rtl ? 'ذكريات ، عن ابنتي عندما كانت مجرد طفلة صغيرة.' : 'memories, involving my daughter when she was just a toddler of one.'}
                </div>
