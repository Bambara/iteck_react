                ...
                <div className="info">
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="cont">
                                <small className="date small mb-20"> <span className="text-uppercase border-end brd-gray pe-3 me-3"> News </span> <i className="far fa-clock me-1"></i> Posted on 3
                                    Days ago </small>
                                <h2 className="title">
                                    Solutions For Big Data Issue, Expert Perspective
                                </h2>
                                <p className="fs-12px mt-10 text-light text-info">If there’s one way that wireless technology has changed the way we work, it’s that will everyone is now connected
                                    [...]</p>
                            </div>
                        </div>
                    </div>
