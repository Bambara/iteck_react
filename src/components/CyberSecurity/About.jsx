                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-6">
                        <div className="info">
                            ...
                            <p> These cyberattacks are usually aimed at accessing, changing, <br/> or destroying sensitive information; extorting money from user <br/> or interrupting normal
