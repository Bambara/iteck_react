                        ...
                        <div className="col-lg-5">
                            <div className="blog-card">
                                ...
                                <div className="info">
                                    ...
                                    <div className="date"><a href="#"> Nov 21, 2022 </a> <span className="color-999 mx-3"> | </span> <a href="#"> <span className="color-999"> By </span> Admin </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="col-lg-6">
                                        <div className="blog-card mt-4 mt-lg-0">
                                            <div className="info w-100">
                                                ...
                                                <p> One of the most important WIP of a blog design is readability. An sure that the background and foreground colors. </p>
                                                <div className="date"><a href="#"> Nov 21, 2022 </a> <span className="color-999 mx-3"> | </span> <a href="#"> <span
                                                    className="color-999"> By </span> Admin </a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-6">
