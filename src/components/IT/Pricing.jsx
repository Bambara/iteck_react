                        ...
                        <div className="content">
                            <div className="toggle_switch d-flex align-items-center justify-content-center mb-20">
                                <div className="form-check form-switch text-white p-0">
                                    ...
                                    <input className="form-check-input float-none color-lightBlue" type="checkbox" id="monthly-input2" defaultChecked
                            ...
                            <p className="text-white text-center mt-50">You have a large team? <Link href="/page-contact-5"><a className="text-decoration-underline">Contact us</a></Link> for
                                information about more enterprise options </p>
                        </div>
                    </div>
                </div>
            </div>
