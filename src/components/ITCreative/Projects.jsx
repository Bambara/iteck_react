                            ...
                            <ul className="nav nav-pills flex-column mb-3" id="pills-tab" role="tablist">
                                {
                                    projects.types.map((type, index) => (
                                        <li className="nav-item" role="presentation" key={index}>
                                            <button className={`nav-link ${index === 0 ? 'active' : ''}`} id={`pills-proj${type.id}-tab`} data-bs-toggle="pill"
                                                    data-bs-target={`#pills-proj${type.tab}`} type="button" role="tab" aria-controls={`pills-proj${type.tab}`} aria-selected="true">
                        ...
                        <div className="tab-content" id="pills-tabContent">
                            {
                                projects.tabs.map((tab, index) => (
                                    <div className={`tab-pane fade ${index === 0 ? 'show active' : ''}`} id={`pills-proj${tab.id}`} role="tabpanel" aria-labelledby={`pills-proj${tab.id}-tab`}
                                         key={index}>
