        ...
        <section className="services style-3 section-padding pb-70" data-scroll-index="2">
            <div className="container">
                <div className="section-head style-3 d-flex align-items-center">
                    <h3>Our Main <span>Services</span></h3> <Link href="/page-services-5"><a className="text-muted ms-5 ps-5 mt-2">See full services <i
                    className="bi bi-chevron-right ms-1"></i></a></Link>
                </div>
                <div className="row">
                    {
