                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-12">
                                        <div className="form-group">
                                            <textarea name="message" rows="10" className="form-control" placeholder={rtl ? "كيف يمكننا مساعدتك?" : "How can we help you?"}
                                    ...
                                    <div className="col-lg-12 text-center">
                                        <input type="submit" value={rtl ? "أرسل طلبك" : "Send Your Request"}
                                               className="btn rounded-pill blue5-3Dbutn hover-blue2 sm-butn fw-bold text-light"></input>
                                    </div>
                                </div>
                            </form>
                        </div>
