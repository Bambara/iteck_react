                ...
                <div className="row gx-0 justify-content-between">
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="items">
                            ...
                            <small className="color-666">{rtl ? "سجل الآن للحصول على آخر التحديثات على" : "Register now to get latest updates on"}
                                <br/> {rtl ? "الترقيات والقسائم." : "promotions & coupons."}</small>
                  ...
                  <span className="icon">
                    <i className="bi bi-envelope"></i>
                            ...
                            <small className="color-666 fst-italic mt-20">{rtl ? "من خلال الاشتراك ، فإنك توافق على" : "By subscribing, you accepted the our"} <a href="#"
                                                                                                                                                                  className="fst-normal text-dark">{rtl ? "سياستنا." : "Policy."}</a>
                            </small>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <small className="small">
                                {rtl ? "© 2022 حقوق التأليف والنشر" : "© 2022 Copyrights by"} <small className="fw-bold text-decoration-underline">Iteck
                                Co.</small> {rtl ? "كل الحقوق محفوظة. صمم بواسطة" : "All Rights Reserved. Designed by"} <a href="https://themeforest.net/user/themescamp"
                                                                                                                           className="fw-bold text-decoration-underline">ThemesCamp</a>
                            </small>
                        </div>
                    </div>
                </div>
