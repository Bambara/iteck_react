                ...
                <ul className="nav nav-pills" id="pills-tab" role="tablist">
                    {
                        data.nav_pills.map((nav, i) => (
                            <li className="nav-item" role="presentation" key={i}>
                                <button className={`nav-link ${i === 0 ? 'active' : ''}`} id={`${nav.id}-tab`} data-bs-toggle="pill" data-bs-target={`#${nav.id}`} type="button" role="tab"
                                        aria-controls={nav.id} aria-selected="true" onClick={() => openTab(nav.id)}>{nav.title}</button>
                            </li>
                        ))
                    }
                </ul>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="form-group mb-30">
                                                        <textarea className="form-control radius-4 fs-12px p-3" rows="6"
                                                                  placeholder={rtl ? 'أكتب تعليقك هنا' : "Write your comment here"}></textarea>
                                                    </div>
                                                </div>
