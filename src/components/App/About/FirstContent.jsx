                        ...
                        <div className="info">
                            ...
                            <p className="text mb-40">
                                ...
                                }
                                {
                                    !rtl &&
                                    <>
                                        Stay focused and productive with a clean and clutter-free note <br/> space. The flexible ways to organize your notes: hashtags, nested notebooks, pinning
                                        notes to the top of the note list, etc
                                    </>
                                }
                            </p>
                            <ul>
