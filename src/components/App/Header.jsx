                    ...
                    <div className="row gx-0">
                        <div className="col-lg-6">
                            <div className="info">
                                ...
                                <p className="text">{rtl ? 'لا يلزم الترميز لإجراء التخصيصات. يحتوي المُخصص المباشر' : 'No coding required to make customizations. The live customizer'}<br/>{rtl ? 'على كل ما تحتاجه.' : 'has everything you need.'}
                                </p>
