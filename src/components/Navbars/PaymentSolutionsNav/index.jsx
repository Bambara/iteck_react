            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse align-items-center" id="navbarSupportedContent">
                    ...
                    <div className="nav-side mt-3 mt-lg-0">
                        <a href="#0" className="btn rounded-pill text-dark bg-white hover-red1 shadow-lg fw-bold me-2"
                           target="_blank">
                            <small> Sign In <i className="fal fa-long-arrow-right ms-1"></i> </small>
                        </a>
                        <a href="#0" className="btn rounded-pill text-white bg-red1 shadow-lg fw-bold" target="_blank">
