...
const Navbar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark style-15 p-0" ref={navbarRef}>
            <div className="container content">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className="nav-side">
                        <a href="#0" className="btn rounded-pill bg-red2 fw-bold text-white" target="_blank">
