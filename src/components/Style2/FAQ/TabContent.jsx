                                ...
                                <div className="accordion pt-lg-0" id="accordion1">
                                    ...
                                    <div className="accordion-item">
                                        ...
                                        <div id="bd1" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion1">
                                            <div className="accordion-body">
                                                <div className="text">
                                                    Sass (short for syntactically awesome style sheets) is a preprocessor scripting language that is interpreted or compiled into Cascading Style
                                                    Sheets. The Sass Script is the scripting language itself. Sass consists of two syntaxes.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd2">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd2" aria-expanded="false"
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd3">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd3" aria-expanded="false"
                                ...
                                <div className="accordion" id="accordion2">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd4">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd4" aria-expanded="true"
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd5">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd5" aria-expanded="false"
                                                    aria-controls="collapseTwo">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd6">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd6" aria-expanded="false"
                                                    aria-controls="collapseThree">
                                ...
                                <div className="accordion" id="accordion3">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd7">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd7" aria-expanded="true"
                                                    aria-controls="collapseOne">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd8">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd8" aria-expanded="false"
                                                    aria-controls="collapseTwo">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd9">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd9" aria-expanded="false"
                                                    aria-controls="collapseThree">
                                ...
                                <div className="accordion" id="accordion5">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd10">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd10" aria-expanded="true"
                                                    aria-controls="collapseOne">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd11">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd11" aria-expanded="false"
                                                    aria-controls="collapseTwo">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd12">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd12" aria-expanded="false"
                                                    aria-controls="collapseThree">
                                ...
                                <div className="accordion" id="accordion6">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd13">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd13" aria-expanded="true"
                                                    aria-controls="collapseOne">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd14">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd14" aria-expanded="false"
                                                    aria-controls="collapseTwo">
                                    ...
                                    <div className="accordion-item">
                                        <h2 className="accordion-header" id="hd15">
                                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bd15" aria-expanded="false"
                                                    aria-controls="collapseThree">
