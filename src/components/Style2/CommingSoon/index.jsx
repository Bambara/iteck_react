                            ...
                            <div className="info">
                                ...
                                <div className="subscribe-form">
                                    <div className="form-group">
                                        ...
                                        <button className="butn bg-blue5 rounded-pill py-3 text-white flex-shrink-0 border-0" type="submit"><span> Subscribe Now <i
                                            className="fas fa-long-arrow-right ms-2"></i> </span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
