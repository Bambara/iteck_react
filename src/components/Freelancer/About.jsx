                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="info">
                                <h5> About Me </h5>
                                <div className="text">
                                    I’m an freelance ui & ux designer with over two decades of experience. I’ve covered both Milan’s fashion week and the US primaries in the same year. Above all,
                                    I believe that fair and free press is fundamental to with healthy society the core ideal behind my work.
                                </div>
                                <div className="logos">
