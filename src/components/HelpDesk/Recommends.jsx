        ...
        <section className="Recommends section-padding">
            <div className="container">
                ...
                <div className="content mt-70">
                    ...
                    <p className="color-666 pt-20 border-1 border-top brd-gray text-center mt-50 wow fadeInDown"> Generate leads, create help tickets, and chat across channels <a href="#"
                                                                                                                                                                                   className="color-000 fw-bold"> Get
                        Started Now </a></p>
                </div>
            </div>
        </section>
