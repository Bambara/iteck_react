        ...
        <section className="features style-15">
            <div className="container">
                <div className="section-head text-center mb-50 wow fadeInUp">
                    <h6 className="text-uppercase fw-bold lh-8"><img src="/assets/img/icons/home_15_icon.png" alt="" className="icon-30 me-2"/> <span> core features </span> <img
                        src="/assets/img/icons/home_15_icon.png" alt="" className="icon-30 ms-2"/></h6>
