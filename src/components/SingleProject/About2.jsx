                                    ...
                                    <h5 className="lh-4">
                                        {
                                            rtl ?
                                                <>
                                                    فريق في <a href="#" className={`color-blue${style}`}>@iteck</a> هو مكرس بشكل لا يصدق ، وواسع المعرفة ، ومفيد. كان المنتج النهائي جميلًا ويستحق
                                                    كل بنس. أوصي بشدة بمختبرات.
                                                </>
                                                :
                                                <>
                                                    “The team at <a href="#" className={`color-blue${style}`}>@iteck</a> is incredibly dedicated, knowledgeable, and helpful. The finished product
                                                    was beautiful, and worth every penny. I would absolutely recommend Moonex Labs.”
                                                </>
                                        }
                                    </h5>
                                    <a href="#" className="mt-60 color-666 fs-12px text-uppercase">- <strong
                                        className="color-000">{rtl ? 'جون هنري ' : 'Jhon henry'} </strong>{rtl ? ', المدير التنفيذي في Notero JSC -' : ', ceo at notero jsc -'} </a>
